    ...
    <div className="min-h-screen pt-24 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-8 text-white/70 text-sm leading-relaxed">
          {[
            { title: '1. Objet', content: 'Les présentes CGV s\'appliquent à toutes les ventes conclues entre Sweet Sent et ses clients.' },
            { title: '2. Prix', content: 'Les prix sont indiqués en euros TTC. Sweet Sent se réserve le droit de modifier ses prix à tout moment.' },
